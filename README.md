...
![UML Diagram for my project](Screenshot 2025-11-03 7.57.21 PM.png)
...
My Project is about a store, where you can buy electronics, clothes, and more. The store uses user inputs to get the product, quantity, and the price.  Using the scanner I was able to get the user inputs to make a product. 
